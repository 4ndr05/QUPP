...
<div class="contenedor_imagen_verde"><img src="<?php echo base_url() ?>images/datos_curiosos/<?=$fc->foto?>"/> 
<?php }
}
}?></div>
...
<div class="contenedor_imagen_horizontal"> <?php if($fotoscontenido != null){ 
foreach ($fotoscontenido as $fc){
	if($fc->contenidoID == $contenidos[1]->contenidoID){?>
<div class="contenedor_imagen_amarilla"><img src="<?php echo base_url() ?>images/datos_curiosos/<?=$fc->foto?>"/> 
<?php }
}
}?> </div>
...
<div class="contenedor_imagen_naranja"><img src="<?php echo base_url() ?>images/datos_curiosos/<?=$fc->foto?>"/> 
<?php }
}
}?></div>
...
<div class="contenedor_imagen_azul"><?php if($fotoscontenido != null){ 
foreach ($fotoscontenido as $fc){
	if($fc->contenidoID == $contenidos[3]->contenidoID){?>
<div class="contenedor_imagen_azul"><img src="<?php echo base_url() ?>images/datos_curiosos/<?=$fc->foto?>"/> 
<?php }
}
}?>
 </div>
...
<img src="<?php echo base_url() ?>images/banner_lateral/4.png" />
<img src="<?php echo base_url() ?>images/banner_lateral/4.png" />
 </div>
