...
<input type="text" class="formu_contacto" id="nombre_contacto" pleaceholder="Nombre" name="nombre_contacto" value="<?php echo $this->session->userdata('nombre') . ' ' . $this->session->userdata('apellido') ?>" size="44">
<input type="text" class="formu_contacto" id="mail_contacto" value="<?php echo $this->session->userdata('correo') ?>" size="44" />
...
<li id="enviando_id" onclick="enviar_mail();">
Eviar
</li>
</ul>
...
<div class="leer_anuncio" id="leer_anuncio">
                ...
                success: function(result)
                {
					   ...
					   for (var i = 0; i < result.count; i++)
                    {
						...
						$(".contenedor_galeria").append("images");					
						  ...
						  var cont_info= $(' <div class="titulo_anuncio_publicado">'+data[i].titulo+'</div></br><font> Fecha de publicación:'+data[i].fechaCreacion+'</font></br><font>Sección: Venta</font></br><font>Raza:'+data[i].raza+'</font></br><font>Género:'+data[i].genero+'</font></br><font>Lugar: '+data[i].nombreEstado+'</font></br></br>');
