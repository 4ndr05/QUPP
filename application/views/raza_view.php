...
<img src="<?php echo base_url() ?>images/cerrar.png" onclick="oculta('contenedor_ver_mensaje');"/>
</div>
...
<img src="images/pero_paso_uno.png" class="perro_paso_uno"/>
...
<div class="lateral_lite"></div>
  <img src="images/perrito_lite.png" class="margen" width="29" height="29"/> <font class="title_paquetes_titilos"> PAQUETE LITE </font>
</div>
...
<div class="lateral_regular"></div>
  <img src="images/perrito_regular.png" class="margen" width="29" height="29"/> <font class="title_paquetes_titilos"> PAQUETE REGULAR </font>
...
<div class="lateral_premium"></div>
  <img src="images/perrito_premium.png" class="margen" width="29" height="29"/> <font class="title_paquetes_titilos"> PAQUETE PREMIUM </font>
...
<p class="margen_15_left"> <a href="#"> Tutorial para subir video a <img src="images/logo_youtube.png" width="43" height="16"/> </a> </p>
</br>
<p class="margen_15_left"> 
...
<div class="sub_instrucciones_pasos"> <img style=" margin-left:15px;" src="images/mini_cupon.png"/> Cupones disponibles <font> 2 </font> </div>
<div style="padding:15px;">
...
<img src="images/raza_mes/1.png" width="358" height="439"/>
<img src="images/raza_mes/2.png" width="358" height="439"/>
</div>
    

<div class="contenedor_descripcion">

<div class="title_raza_big"> BOBTAIL</div>

  <div class="title_raza">  Orígenes de la raza </div>
  </br>
<p>  
Es originario de Gran Bretaña donde fue utilizado como perro pastor.
</p>
<div class="title_raza"> Carácter y temperamento </div>
</br>
<p>Es un perro muy fiel e inteligente al que le encanta pasar tiempo con su familia y participar de sus actividades. Tiene un fuerte instinto de pastoreo y hay que hacerle entender que no necesita pastorear a las personas; si no se le marcan bien las pautas que debe seguir puede volverse caprichoso, como ocurre con todas las razas. Son perros muy alegres, afectuosos, cariñosos con los niños que siguen comportándose como cachorros durante bastante tiempo. No es difícil de adiestrar y le encanta jugar. </p>
...
<!-- End perros perdidos -->
<!-- Raza del mes -->
<a href="#" style="text-decoration:none; color:#000;" onmouseover="Mostrar('ver_raza'); Ocultar('ver_perdidos');Ocultar('ver_mes'); Ocultar('ver_curiosos')" >
<div id="la_raza_mes" class="seccion_inferior_izquierda">
<div class="contenido_secciones">
<p class="titulo_segunda_seccion"> FEBRERO </p>
</div>
<div  class="sub_imagenes_dos" >
...
<!-- Eventos del mes -->
<a href="#" style="text-decoration:none; color:#000;" onmouseover="Mostrar('ver_mes');Ocultar('ver_raza'); Ocultar('ver_perdidos');Ocultar('ver_curiosos');" >
<div id="eventos_mes" class="seccion_inferior">
<div class="contenido_secciones">
<p class="titulo_segunda_seccion"> MARZO </p>
</div>
<div  class="sub_imagenes_dos" >
...
<!-- End eventos del mes -->
<!-- Datos curiosos -->
<a href="#" style="text-decoration:none; color:#000;" onmouseover="Mostrar('ver_curiosos');Ocultar('ver_raza'); Ocultar('ver_perdidos');Ocultar('ver_mes');" >
<div id="datos_curiosos" class="seccion_inferior_derecha">
<div class="contenido_secciones">
<p class="titulo_segunda_seccion"> ABRIL </p>
</div>
<div  class="sub_imagenes_dos" >
