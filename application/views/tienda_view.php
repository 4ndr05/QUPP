...
<img src="<?php echo base_url()?>images/productos/<?php echo $item->foto?>" width="184" height="158"/>
<?php else:?>
<img src="<?php echo base_url()?>images/productos/default.png" width="184" height="158"/>
<?php endif;?>
</div>
<div class="contenedor_descripcion_precio_producto detalleProducto" id="<?php echo $item->productoID?>">
